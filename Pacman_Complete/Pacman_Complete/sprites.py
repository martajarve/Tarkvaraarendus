...
class Spritesheet(object):
    def __init__(self):
        # Initsialiseerib sprite'ide lehe
    ...
    def getImage(self, x, y, width, height):
        # Tagastab konkreetse pildi sprite'ide lehelt
        x *= TILEWIDTH
        y *= TILEHEIGHT
...
class PacmanSprites(Spritesheet):
    def __init__(self, entity):
        # Initsialiseerib Ms. Pacmani sprite'ide lehega
    ...
    def defineAnimations(self):
        # Määrab animatsioonid vastavalt suunale
    ...
    def update(self, dt):
        # Uuendab Ms. Pacmani pilti vastavalt suunale ja olekule
    ...
    def reset(self):
        # Taastab animatsiooni algseisundi
        for key in list(self.animations.keys()):
            self.animations[key].reset()

    def getStartImage(self):
        # Tagastab algseisundi pildi
        return self.getImage(8, 0)

    def getImage(self, x, y):
        # Tagastab pildi vastavalt koordinaatidele
        return Spritesheet.getImage(self, x, y, 2*TILEWIDTH, 2*TILEHEIGHT)


class GhostSprites(Spritesheet):
    def __init__(self, entity):
        # Initsialiseerib kummituse sprite'ide lehega
        Spritesheet.__init__(self)
    ...
    def update(self, dt):
        # Uuendab kummituse pilti vastavalt suunale ja olekule
...
class FruitSprites(Spritesheet):
    def __init__(self, entity, level):
        # Initsialiseerib puuvilja sprite'ide lehega
        Spritesheet.__init__(self)
        self.entity = entity
